...
export default async function CreateFirstProfile() {
  ...
  const createProfile = async (formData: FormData) => {
    ...
    if (!error) {
      redirect('/select-profile') // Redirect to select profile after first profile created
    }
  }
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-8 sm:p-24 bg-gradient-to-br from-blue-100 to-purple-100">
      <h1 className="text-3xl font-bold mb-4 text-center">Create Your First Listening Profile</h1>
      <p className="text-center text-lg mb-8">Let's set up a profile for the first listener.</p>
